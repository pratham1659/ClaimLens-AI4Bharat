...
# Edit environment configuration (optional - defaults work for local)
nano .env.sample
```
...
Edit your `.env.sample` file with production values:
...
# Configure .env.sample with your production values
nano .env.sample  # Edit with your production configuration
